...
const VenueDetailsPage = lazy(
  () => import("../features/withoutauth/pages/VenueDetailsPage")
);
...
const EditProfile = lazy(
  () => import("../features/auth/components/EditProfile")
);
const CorporateBookingPage = lazy(
  () => import("../features/withoutauth/pages/CorporateBookingPage")
);
const PartnerPage = lazy(
  () => import("../features/withoutauth/pages/PartnerPage")
);
...
const SucessfulBooking = lazy(
  () => import("../features/auth/components/paymentSuccess")
);
const PaymentFailed = lazy(
  () => import("../features/withoutauth/components/paymentFailed")
);

// Filter pages
const RunFilterPage = lazy(
  () => import("../features/withoutauth/pages/FilterPages/RunFilter")
);
const RunDetailPage = lazy(
  () => import("../features/withoutauth/pages/RunDetailPage")
);
const EventFilterPage = lazy(
  () => import("../features/withoutauth/pages/FilterPages/EventFilter")
);
const EventDetailPage = lazy(
  () => import("../features/withoutauth/pages/EventDetailPage")
);
const CoachFilterPage = lazy(
  () => import("../features/withoutauth/pages/FilterPages/CoachFilter")
);
const CoachDetailPage = lazy(
  () => import("../features/withoutauth/pages/CoachDetailPage")
);
const GymFilterPage = lazy(
  () => import("../features/withoutauth/pages/FilterPages/GymFilter")
);
const GymDetailPage = lazy(
  () => import("../features/withoutauth/pages/GymDetailPage")
);
const HostFilterPage = lazy(
  () => import("../features/withoutauth/pages/FilterPages/HostPlayFilter")
);
    ...
    <div style={{ marginTop: "4.6rem" }}>
      <Suspense fallback={<div>Loading...</div>}>
        ...
        <Routes>
          ...
          <Route
            path="/venue"
            element={<VenuePage key={location.pathname} />}
          />
