...
import logo from "../assets/sportdantaLogo/blackLogo1.png"; // Replace with correct logo path
    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-links">
          ...
          <div>
            ...
            <ul>
              <li>
                <img src={phonelogo} alt="phonelogo"></img>+91-8884803877
              </li>
              <li>
      ...
      <div className="footer-bottom">
        ...
        <ul>
          ...
          <li>
            <Link to="/RefundPolicy">Legal</Link>
          </li>
           <li>
            <Link to="/RefundPolicy">Site Map</Link>
          </li>
        </ul>
      </div>
    </footer>
