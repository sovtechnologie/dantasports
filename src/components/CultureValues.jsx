...
const values = [
  {
    ...
    description:
      "We take bold risks, embrace mistakes, and take full ownership of every outcome.",
  },
  {
    icon: playerIcon,
  ...
  },
  {
    ...
    description:
      "Slowing down is never an option. We push boundaries, delivering top-quality solutions.",
  },
  {
    icon: longTermIcon,
...
const CultureValues = () => {
  ...
  return (
    <section
      ref={ref}
      className={`culture-values-section${isVisible ? " culture-visible" : ""}`}
    >
