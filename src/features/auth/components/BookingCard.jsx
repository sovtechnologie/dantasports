    ...
    <div className="booking-card-container">
      ...
      <div className="booking-card-details">
        ...
        <div className="booking-card-actions">
          ...
          {isCompleted ? (
            <button className="action-btn review" onClick={() => setIsModalOpen(true)}
              disabled={existing}>
              {existing ? "Reviewed ✓" : "Add Review"}
            </button>
          ) : (
            isCancelled ? < button className="action-btn cancelled">
              Cancelled
            </button> : < button className="action-btn cancel">
